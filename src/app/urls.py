...
urlpatterns = [
    ...
    re_path(
        r"^download-preinvoice/(?P<id>\d+)$",
        views.download_preinvoice,
        name="download_preinvoice",
    ),
    re_path(
        r"^template-preinvoice/(?P<id>\d+)$",
        views.template_preinvoice,
        name="template_preinvoice",
    ),
]
