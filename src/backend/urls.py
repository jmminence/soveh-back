...
urlpatterns = [
    ...
    path("consolidado/<int:id>/download_SG", csrf_exempt(views.download_consolidados_SG), name="download_consolidados_SG"), #Integración SG URL  26/03/2024
    path("consolidado/<int:id>/template_SG", csrf_exempt(views.template_consolidados_SG), name="template_consolidados_SG"),
    path("consolidado/<int:id>/template_SG_diagnostic", csrf_exempt(views.template_consolidados_SG_diagnostic), name="template_consolidados_SG_diagnostic"),
    path("consolidado/<int:id>/template_SG_contraportada", csrf_exempt(views.template_consolidados_SG_contraportada), name="template_consolidados_SG_contraportada"),
